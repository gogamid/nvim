return {
  ...
  keys = {
...

    {
      "<leader>tml",
      function()
        require("overseer").run_template({ name = "make lint" })
      end,
      desc = "Make Lint",
    },
    {
      "<leader>tmt",
      function()
        require("overseer").run_template({ name = "make test" })
      end,
      desc = "Make Test",
    },
    {
    ...
    },
    {
      "<leader>tl",
      function()
        require("overseer").run_template({ name = "test-line" })
      end,
      desc = "Test line",
    },
    {
      "<leader>tf",
      function()
        require("overseer").run_template({ name = "test-file" })
      end,
      desc = "Test file",
    },
    {
