...
vim.api.nvim_set_hl(
  0,
  "@markup.link.url",
  { cterm = { italic = true, underline = true }, fg = 16113884, italic = true, underline = true }
)
...
vim.api.nvim_set_hl(0, "CursorLine", { bg = 3091522 })
vim.api.nvim_set_hl(0, "CursorLineNr", { fg = 13804797 })
...
vim.api.nvim_set_hl(0, "DiagnosticUnderlineError", { cterm = { undercurl = true }, sp = 15961000, undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineHint", { cterm = { undercurl = true }, sp = 9757397, undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineInfo", { cterm = { undercurl = true }, sp = 9034987, undercurl = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineOk", { cterm = { underline = true }, sp = 10937249, underline = true })
vim.api.nvim_set_hl(0, "DiagnosticUnderlineWarn", { cterm = { undercurl = true }, sp = 16376495, undercurl = true })
...
vim.api.nvim_set_hl(0, "NormalFloat", { fg = 13489908 })
...
vim.api.nvim_set_hl(0, "StatusLine", { fg = 0xD9E0EE, bg = "none" })
vim.api.nvim_set_hl(0, "StatusLineNC", { fg = 0x6E6C7E, bg = "none" })
